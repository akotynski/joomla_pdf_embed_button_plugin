...
<br>
Styl: <input type="radio" name="engine" value="native">Native <input type="radio" name="engine" value="google" checked>Google <input type="radio" name="engine" value="pdfjs">pdfjs
<br><br>
